...
public class ftLightingDataGen
{
    ...
    public static bool GenerateShadowmaskLightingData(string outName, ref List<Light> lights)
    {
        ...
        try
        {
            ...
            var bytesP0 = File.ReadAllBytes("Assets/Editor/x64/Bakery/lightingDataChunks/LightingData_2017_1_part0.bin");
            var bytesP1 = File.ReadAllBytes("Assets/Editor/x64/Bakery/lightingDataChunks/LightingData_2017_1_part1.bin");
            var bytesP2 = File.ReadAllBytes("Assets/Editor/x64/Bakery/lightingDataChunks/LightingData_2017_1_part2.bin");
            var bytesP3 = File.ReadAllBytes("Assets/Editor/x64/Bakery/lightingDataChunks/LightingData_2017_1_part3.bin");
#else
            var bytesP0 = File.ReadAllBytes("Assets/Editor/x64/Bakery/lightingDataChunks/LightingData_5_6_part0.bin");
            var bytesP1 = File.ReadAllBytes("Assets/Editor/x64/Bakery/lightingDataChunks/LightingData_5_6_part1.bin");
            var bytesP2 = File.ReadAllBytes("Assets/Editor/x64/Bakery/lightingDataChunks/LightingData_5_6_part2.bin");
            var bytesP3 = File.ReadAllBytes("Assets/Editor/x64/Bakery/lightingDataChunks/LightingData_5_6_part3.bin");
#endif
